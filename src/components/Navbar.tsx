    ...
    >
      ...
      {open && (
        <div className="md:hidden glass-strong px-6 pb-6 flex flex-col gap-4 text-sm text-muted-foreground border-t border-border/30">
          ...
          <a href="#cta" onClick={() => setOpen(false)} className="inline-flex items-center justify-center rounded-full bg-primary px-6 py-3 font-semibold text-primary-foreground mt-2">Get Started</a>
        </div>
      )}
    </nav>
  );
