    ...
    <section id="cta" className="relative py-24 px-6">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#"
            className="inline-flex items-center gap-2 rounded-lg bg-primary px-8 py-3.5 text-sm font-semibold text-primary-foreground transition-all hover:shadow-[0_0_30px_oklch(0.78_0.08_260_/_30%)]"
          >
            Apply for Scale <ArrowRight size={16} />
          </a>
          <a
            href="#"
            className="inline-flex items-center gap-2 rounded-lg glass glow-border px-8 py-3.5 text-sm font-semibold text-foreground transition-all glow-border-hover"
          >
